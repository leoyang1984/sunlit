...
This directory keeps historical planning, spike, and skill-drafting documents out of the current user-facing documentation set.
...
Archived documents may still contain useful context, but they should not be treated as the current implementation contract.
